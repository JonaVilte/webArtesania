    ...
    <main className="min-h-screen flex flex-col">
      <section className="relative w-full h-[500px]">
        ...
        <div className="absolute inset-0 bg-black/30 flex flex-col items-center justify-center text-center px-4">
          <h1 className="text-7xl md:text-8xl font-bold text-[#f8f3d9] drop-shadow-lg">Artesanía</h1>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4">
        ...
        <section className="mt-12 flex flex-col md:flex-row gap-8 items-center">
          <div className="md:w-1/2">
            <h2 className="text-3xl font-semibold mb-4">Bienvenidos a nuestra tienda de artesanías</h2>
            <p className="mb-4">
